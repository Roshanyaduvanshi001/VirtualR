  ...
  return (
    <div className="flex flex-col items-center mt-4 lg:mt-20">
        ...
        <p className='mt-10 text-lg text-center text-neutral-500 max-w-4xl'>
            Empower your creativity and bring your VR app to life with out 
            intuitives development tools. Get started today and turn your imagination
            into imersiver reality!
        </p>
